 ...
 */
export const updateGroupContract = onCall({ cors: vivoGameDef.corsOrigins }, async (request) => {
  ...
  if (agreement_reached) {
    ...
    const check = validateOutcome(vivoGameDef.outcomeSchema, provided as Outcome)
    if (!check.valid) {
